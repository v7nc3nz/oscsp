...
$docs = array(
	...
	'PHPIDS-license' => array( 'legend' => 'PHPIDS License', 'file' => OSCSP_WEB_PAGE_TO_PHPIDS . 'LICENSE' ),
);
...
$instructions = file_get_contents( OSCSP_WEB_PAGE_TO_ROOT.$readFile );

function urlReplace( $matches ) {
	return oscspExternalLinkUrlGet( $matches[1] );
}
