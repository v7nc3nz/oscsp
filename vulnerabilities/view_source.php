...
$source = @file_get_contents( OSCSP_WEB_PAGE_TO_ROOT . "vulnerabilities/{$id}/source/{$security}.php" );
$source = str_replace( array( '$html .=' ), array( 'echo' ), $source );

$js_html = "";
if (file_exists (OSCSP_WEB_PAGE_TO_ROOT . "vulnerabilities/{$id}/source/{$security}.js")) {
	$js_source = @file_get_contents( OSCSP_WEB_PAGE_TO_ROOT . "vulnerabilities/{$id}/source/{$security}.js" );
	$js_html = "
